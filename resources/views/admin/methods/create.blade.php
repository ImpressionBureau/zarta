@extends('layouts.admin', ['app_title' => 'Новый метод лечения'])
    ...
    <section>
        ...
        <form action="{{ route('admin.methods.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <image-uploader name="method" ratio="67%"></image-uploader>
                </div>
            </div>
            <div class="mt-4">
        ...
        @else
            <a href="{{route('admin.categories.create')}}"><h2>Cначала создайте категорию для методов работы</h2></a>
        @endif
    </section>
