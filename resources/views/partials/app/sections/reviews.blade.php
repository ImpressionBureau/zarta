                            ...
                            <div class="texting-slider__item">
                                <div class="row justify-content-center">
                                    <div class="col-sm-8 col-md-6 col-lg-4">
                                        <div class="avatar lozad mb-4 mb-xl-0"
                                             data-background-image="{{$review->hasMedia('review') ? $review->getFirstMedia('review')->getFullUrl('preview') : asset('images/no-image.png')}}"></div>
                                    </div>
...
{{--                        </div>--}}
        ...
        <a href="#" class="appointment lozad d-flex flex-column align-items-center justify-content-center modal-btn"
           data-background-image="background-image: url('{{ asset('images/appointment-bg.jpg') }}')">
