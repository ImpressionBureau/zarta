    ...
    <div class="menu-content">
        <div class="container-fluid">
            <div class="row justify-content-center justify-content-xl-between">
                ...
                <div class="col-sm-10 col-md-8 col-lg-3 col-xl-auto col-sm-6">
                    <div class="menu-item">
                        <a href="{{route('app.services.index')}}" class="menu-item__title">@lang('common.menu.services')</a>
                    </div>
                </div>
                <div class="col-sm-10 col-md-8 col-lg-3 col-xl-auto col-sm-6">
                    <div class="menu-item">
                        <a href="{{ route('app.faq.index') }}" class="menu-item__title">@lang('common.menu.questions')</a>
                    </div>
                </div>
                <div class="col-sm-10 col-md-8 col-lg-3 col-xl-auto col-sm-6">
                    <div class="menu-item">
                        <a href="{{ route('app.articles.index') }}" class="menu-item__title">@lang('common.menu.blog')</a>
                    </div>
                </div>
                <div class="col-sm-10 col-md-8 col-lg-3 col-xl-auto col-sm-6">
                    <div class="menu-item">
                        <a href="{{route('app.pages.contacts')}}" class="menu-item__title">@lang('common.menu.contacts')</a>
                    </div>
                </div>
            </div>
        </div>
